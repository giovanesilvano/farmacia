...
public class VendaControladaStrategy implements VendaStrategy {
    ...
    @Value("${sngpc.service.url}") private String sngpcUrl;
    private final RestTemplate restTemplate = new RestTemplate();
    @Override
    public void validar(ItemVenda item) {
        if (item.getReceitaId() == null) throw new ReceitaInvalidaException("Receita obrigatória para medicamento controlado");
