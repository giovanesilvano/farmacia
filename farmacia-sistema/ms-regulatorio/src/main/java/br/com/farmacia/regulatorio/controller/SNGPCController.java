...
public class SNGPCController {
    @Autowired
    private SNGPCService service;

    @PostMapping("/registrar")
    public ResponseEntity<RegistroSNGPC> registrar(@RequestBody Map<String, Object> dados) {
        return ResponseEntity.ok(service.registrar(dados));
    }

    @GetMapping
    public ResponseEntity<List<RegistroSNGPC>> listar() {
